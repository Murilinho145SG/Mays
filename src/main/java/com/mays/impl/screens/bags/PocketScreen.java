...
public class PocketScreen extends AbstractContainerScreen<PocketContainer> {
    private final ResourceLocation GUI = new ResourceLocation(Mays.MODID, "textures/gui/pocket_container.png");

    public PocketScreen(PocketContainer bagContainer, Inventory inventory, Component component) {
